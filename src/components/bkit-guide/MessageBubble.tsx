        ...
        {isUser ? (
          ...
          <div
            className="prose prose-invert prose-sm max-w-none
              ...
              prose-p:text-gray-200 prose-p:leading-loose prose-p:my-6
              prose-strong:text-white
              prose-code:text-emerald-300 prose-code:bg-gray-700 prose-code:px-1 prose-code:py-0.5 prose-code:rounded
              prose-pre:bg-gray-900 prose-pre:border prose-pre:border-gray-700 prose-pre:my-6
              prose-ul:text-gray-200 prose-ul:my-6
              prose-ol:text-gray-200 prose-ol:my-6
              prose-li:marker:text-emerald-400 prose-li:my-4
              prose-table:border prose-table:border-gray-600 prose-table:border-collapse prose-table:my-6
